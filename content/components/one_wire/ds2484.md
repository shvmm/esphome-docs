...
The `ds2484` platform provides access to 1-Wire busses via DS2484 device using the [I²C Bus](#i2c) for
communication.
...
- **i2c_id** (*Optional*, [ID](#config-id)): Manually specify the ID of the {{< docref "/components/i2c" >}}. Required if you
