...
load cell amplifier
([datasheet](https://www.mouser.com/ds/2/813/hx711_english-1022875.pdf), `SparkFun`_) with ESPHome

{{< img src="hx711-full.jpg" alt="Image" caption="HX711 Load Cell Amplifier. Image by `SparkFun`_ licensed and re-distributed under [CC BY 2.0](https://creativecommons.org/licenses/by/2.0/)." width="60.0%" class="center" >}}
...
- **dout_pin** (**Required**, [Pin Schema](#config-pin_schema)): The DOUT (or DAT) pin.
- **clk_pin** (**Required**, [Pin Schema](#config-pin_schema)): The CLK pin.
