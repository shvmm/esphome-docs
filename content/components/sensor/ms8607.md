...
pressure and humidity sensors with ESPHome. An [I²C Bus](#i2c) is required to be set up in
...
- **humidity** (*Optional*): The information for the humidity sensor.
  ...
  - **i2c_id** (*Optional*, [ID](#config-id)): Manually specify the ID of the [I²C Component](#i2c) if your
