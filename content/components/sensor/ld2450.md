...
{{< /note >}}
{{< img src="ld2450.png" alt="Image" caption="HLK-LD2450 radar module" width="50.0%" class="center" >}}
...
The `ld2450` button allows you to perfrom `restart` and `factory reset` actions on your {{< docref "ld2450/" >}}.
