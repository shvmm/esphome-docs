...
{{< img src="t6615.png" alt="Image" caption="T6615 CO_2 Sensor." width="50.0%" class="center" >}}
...
{{< img src="t6615-pins.png" alt="Image" caption="Pins on the T6615. Only the ones marked with a red circle need to be connected." width="80.0%" class="center" >}}
