...
{{< img src="max31865-full.jpg" alt="Image" caption="MAX31865 Sensor. Image by `Adafruit`_" width="50.0%" class="center" >}}

As the communication with the MAX31865 is done using SPI, you need
to have an [spi bus](#spi) in your configuration with both **miso_pin** and **mosi_pin** set.
