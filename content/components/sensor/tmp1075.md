...
{{< img src="tmp1075.jpg" alt="Image" caption="TMP1075 Temperature Sensor. (Credit: [Texas Instruments](https://www.ti.com/content/dam/ticom/images/products/ic/sensing-products/chips/tmp1075-technical-chip-shot.png), image cropped and compressed)" width="30.0%" class="center" >}}
...
To use the sensor, first set up an [I²C Bus](#i2c) and connect the sensor
