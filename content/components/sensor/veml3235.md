...
{{< img src="veml3235.jpg" alt="Image" caption="The VEML3235 Ambient Light Sensor" width="50.0%" class="center" >}}
...
- **integration_time** (*Optional*, [Time](#config-time)): The time the device will use for each measurement. Longer
