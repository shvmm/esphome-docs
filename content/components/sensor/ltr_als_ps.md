...
- **update_interval** (*Optional*, [Time](#config-time)): The interval for checking the sensors.
  Defaults to `60s`.
- **ps_cooldown** (*Optional*, [Time](#config-time)): The "cooldown" period after the proximity sensor is triggered.
