...
{{< img src="opt3001-full.jpg" alt="Image" caption="OPT3001 Ambient Light Sensor." width="50.0%" class="center" >}}
...
- **id** (*Optional*, [ID](#config-id)): Manually specify the ID used for code
  generation.
