...
`M5Stack`_) sensors with ESPHome. The [I²C Bus](#i2c) is required to be set up in your configuration for this
sensor to work.
...
{{< img src="mpu6886-ui.png" alt="Image" width="80.0%" class="center" >}}
