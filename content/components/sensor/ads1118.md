...
{{< img src="ads1118-full.jpg" alt="Image" caption="ADS1118 16-Bit ADC." width="60.0%" class="center" >}}
...
- **id** (*Optional*, [ID](#config-id)): Manually specify the ID for this ADS1118 Hub. Use this if you
...
- **ads1118_id** (*Optional*, [ID](#config-id)): Manually specify the ID of the
