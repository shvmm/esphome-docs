...
- **sensor** (**Required**, [ID](#config-id)): The ADC sensor to measure the sensor's output voltage pulses from.
...
- **output** (**Required**, [ID](#config-id)): The binary [Output Component](#output) to control the sensor's internal IR LED.
