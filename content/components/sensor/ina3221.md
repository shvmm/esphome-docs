...
{{< img src="ina3221-full.jpg" alt="Image" caption="INA3221 3-Channel DC Current Sensor" width="50.0%" class="center" >}}

{{< img src="ina3221-ui.png" alt="Image" width="80.0%" class="center" >}}
...
{{< img src="ina3221-pins.jpg" alt="Image" caption="Pins on the INA3221. For communication only VS, GND, SCL and SDA need to be connected. Note that all 3 channels share the same GND reference." width="60.0%" class="center" >}}
