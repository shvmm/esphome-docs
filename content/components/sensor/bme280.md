...
the sensor returns to sleep mode until next measurement. The [I²C](#i2c) or [SPI](#spi) is
required to be set up in your configuration for this sensor to work.

**Note:** In [I²C](#i2c) mode pulling CSB to 3V is recommended, in order to avoid `[E][sensor.bme280:155]: Communication with BME280 failed!` error. See the *Connection diagram* chapter in datasheet above.

{{< img src="bme280-full.jpg" alt="Image" caption="BME280 Temperature, Pressure & Humidity Sensor." width="50.0%" class="center" >}}
...
- **cs_pin** (*Optional*, [Pin Schema](#config-pin_schema)): The CS pin of the BME280 sensor.
