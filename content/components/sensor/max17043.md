...
`DFRobot`_) in ESPHome. It uses the [I²C Bus](#i2c) for communication (the address is fixed at 0x36).
...
{{< /note >}}
{{< img src="max17043.jpg" alt="Image" caption="DFRobot DFR0563 Gravity I2C 3.7V Li battery fuel gauge." width="60.0%" class="center" >}}
