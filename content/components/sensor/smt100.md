...
{{< img src="smt100.jpg" alt="Image" width="50.0%" class="center" >}}

The communication with this component is done via a [UART](#uart) using a simple ASCII protocol. You must
...
- **update_interval** (*Optional*, [Time](#config-time)): The interval to poll the sensor. Defaults is 60s.
