...
{{< img src="cs5460a.png" alt="Image" caption="CS5460A Single-Phase Power/Energy IC module" width="30.0%" class="center" >}}
...
Your device communicates with the CS5460A over SPI so you need to have an [SPI bus](#spi) in
...
- **current** (*Optional*): The sensor subcomponent that will report RMS current values in Amperes.
  All options from [Sensor](#config-sensor).  See note below about throttling.
...
{{< /note >}}
    ...
    shorter, consider [filtering](#sensor-filters) the measurements if you have a Home
