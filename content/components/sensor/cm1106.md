...
{{< img src="cm1106.png" alt="Image" caption="CUBIC CM1106 Single Beam NDIR CO2 Sensor Module." width="50.0%" class="center" >}}

Communication with the CM1106 sensor is done via UART, so you need to define a
[UART bus](#uart) in your configuration. Connect the `rx_pin` to the TX pin of the CM1106
