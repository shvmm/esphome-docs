...
Communication with the device is over [I²C](#i2c), which must be present in your configuration. VEML7700 and VEML6030
...
{{< img src="veml7700-full.jpg" alt="Image" caption="VEML7700 Ambient Light Sensor on a board and standalone sensors." width="70.0%" class="center" >}}

{{< img src="veml7700-ui.png" alt="Image" caption="VEML sensor in Home Assistant UI." width="60.0%" class="center" >}}
...
{{< img src="veml7700-spectral.png" alt="Image" caption="ALS and WHITE channels spectral response" width="100.0%" class="center" >}}
...
All options from [Sensor](#config-sensor) are supported.
