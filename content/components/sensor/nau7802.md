...
([datasheet](https://www.nuvoton.com/resource-files/NAU7802%20Data%20Sheet%20V1.7.pdf), `Adafruit`_) with ESPHome. This ADC is typically used with strain gauges to act as a weight sensor.

{{< img src="nau7802.png" alt="Image" caption="NAU7802 on a breakout board. Image by `Adafruit`_" width="60.0%" class="center" >}}
