...
a 12-Bit integrated ADC with [I²C](#i2c), and is meant to act as a high-side current sense amplifier.

The [I²C](#i2c) is
required to be set up in your configuration for this sensor to work.

{{< img src="max9611.jpg" alt="Image" caption="MAX9611 High-Side Current-Sense Amplifier" width="50.0%" class="center" >}}
