...
the [I²C Bus](#i2c) and connect the sensor to the pins specified there.

{{< img src="as5600-full.jpg" alt="Image" caption="AS5600 12-Bit Magnetic Position Sensor." width="50.0%" class="center" >}}
...
- **id** (*Optional*, [ID](#config-id)): Manually specify the ID for this AS5600 Hub.
...
{{< img src="as5600-magnet-position.png" alt="Image" width="80.0%" class="center" >}}
...
{{< img src="as5600-ui.jpg" alt="Image" width="80.0%" class="center" >}}
...
- **as5600_id** (*Optional*, [ID](#config-id)): Manually specify the ID of the
...
{{< img src="as5600-ui-derived.jpg" alt="Image" width="80.0%" class="center" >}}
