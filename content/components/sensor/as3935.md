...
| --- | --- |
|  CC/VDD |  Positive supply voltage |
|  ND |  Ground |
|  CL |  I²C clock bus or SPI clock bus (according to SI setting) |
|  OSI |  I²C data bus or SPI data input bus (according to SI setting) |
|  ISO |  SPI data output bus |
|  S |  Chip Select (active low) |
|  I |  Select Interface (GND → SPI or VDD → I²C) |
|  RQ |  Interrupt (out) |
|  N_V |  Voltage Regulator Enable |
|  0 |  I²C address selection LSB |
|  1 |  I²C address selection MSB |

{{< img src="as3935.jpg" alt="Image" caption="AS3935 Lightning Sensor." width="50.0%" class="center" >}}
...
- **irq_pin** (**Required**, [Pin](#config-pin)): The IRQ pin, which indicates if a lightning strike has been detected.
