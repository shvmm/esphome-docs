...
{{< img src="sds011-full.jpg" alt="Image" caption="SDS011 Particulate Matter Sensor" width="50.0%" class="center" >}}
...
- **update_interval** (*Optional*, [Time](#config-time)): The interval to check the sensor in minutes.
