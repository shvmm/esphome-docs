...
`Adafruit`_) temperature and pressure sensors with ESPHome. The [I²C](#i2c) or [SPI](#spi) is
required to be set up in your configuration for this sensor to work.

{{< img src="bmp280-full.jpg" alt="Image" caption="BMP280 Temperature and Pressure Sensor." width="50.0%" class="center" >}}
...
- **cs_pin** (*Optional*, [Pin Schema](#config-pin_schema)): The CS pin of the BMP280 sensor.


{{< img src="bmp280-full.jpg" alt="Image" caption="Pins on the BMP280. Only VCC, GND, SCL, and SDA need to be connected." width="60.0%" class="center" >}}
