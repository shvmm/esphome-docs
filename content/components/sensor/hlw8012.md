...
- **sel_pin** (**Required**, [Pin Schema](#config-pin_schema)): The pin SEL is connected to.
- **cf_pin** (**Required**, [Pin](#config-pin)): The pin CF is connected to.
- **cf1_pin** (**Required**, [Pin](#config-pin)): The pin CF1 is connected to.
