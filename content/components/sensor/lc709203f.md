...
- **battery_voltage** (*Optional*): Configuration for the voltage sensor. All options from [sensor](#config-sensor).

- **battery_level** (*Optional*): Configuration for the battery level sensor. All options from [Sensor](#config-sensor).
