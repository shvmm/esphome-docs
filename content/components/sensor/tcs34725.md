...
`Adafruit`_), color temperature and illuminance sensors with ESPHome. The [I²C](#i2c) is
...
{{< img src="tcs34725-full.jpg" alt="Image" caption="TCS34725 RGB Color Sensor" width="50.0%" class="center" >}}

{{< img src="tcs34725-ui.png" alt="Image" width="80.0%" class="center" >}}
