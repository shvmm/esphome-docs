...
The [I²C](#i2c) or [SPI](#spi) is required to be set up in your configuration for this sensor to work.
...
{{< /note >}}
{{< img src="ens160.jpg" alt="Image" caption="ENS160 Air Quality Sensor." width="80.0%" class="center" >}}
...
- **cs_pin** (**Required**, [Pin Schema](#config-pin_schema)): *SPI only.* The Chip Select pin.
...
- **compensation** (*Optional*): The block containing sensors used for compensation.
  ...
  - **temperature** (**Required**, [ID](#config-id)): The ID of an external temperature sensor.
  - **humidity** (**Required**, [ID](#config-id)): The ID of an external humidity sensor.
