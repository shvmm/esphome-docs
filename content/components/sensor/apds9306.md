...
The `apds9306` sensor component allows you to use APDS9306 ambient light sensors ([datasheet](https://docs.broadcom.com/doc/AV02-4755EN), `Broadcom`_) with ESPHome.
The [I²C](#i2c) is required to be set up in your configuration for this sensor to work.

{{< img src="apds9306.png" alt="Image" caption="Image by `Broadcom`_" width="80.0%" class="center" >}}
