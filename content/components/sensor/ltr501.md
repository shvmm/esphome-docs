...
{{< img src="ltr501-full.jpg" alt="Image" caption="LTR-501 on a breadboard from Olimex" width="60.0%" class="center" >}}

{{< img src="ltr501-ui.png" alt="Image" caption="LTR-501 Sensor in Home Assistant UI." width="60.0%" class="center" >}}
...
The sensors are very similar and share the same datasheet. The [I²C Bus](#i2c) is required to be set up in your
