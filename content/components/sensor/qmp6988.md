...
`M5Stack`_) temperature and pressure sensors with ESPHome. The [I²C](#i2c) is
required to be set up in your configuration for this sensor to work.

{{< img src="qmp6988_env3.png" alt="Image" caption="QMP6988 Temperature and Pressure Sensor." width="40.0%" class="center" >}}
