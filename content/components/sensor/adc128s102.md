...
{{< img src="adc128s102.png" alt="Image" width="50.0%" class="center" >}}
...
- **id** (**Required**, [ID](#config-id)): The id to use for this ADC128S102 component.
...
- **adc128s102_id** (**Required**, [ID](#config-id)): The id of the parent ADC128S102 component.
