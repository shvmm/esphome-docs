...
`SparkFun`_) sensors with ESPHome. The [I²C Bus](#i2c) is required to be set up in your configuration for this
sensor to work.
...
{{< img src="mpu6050-full.jpg" alt="Image" caption="MPU6050 Accelerometer/Gyroscope Sensor." width="50.0%" class="center" >}}

{{< img src="mpu6050-ui.png" alt="Image" width="80.0%" class="center" >}}
