...
([datasheet](http://www.ti.com/lit/ds/symlink/ina226.pdf), `eBay`_) sensors with ESPHome.
The [I²C Bus](#i2c) is required to be set up in your configuration for this sensor to work.


{{< img src="ina226-full.jpg" alt="Image" caption="INA226 DC Current and Power Sensor." width="50.0%" class="center" >}}
