...
The [I²C Bus](#i2c) is required to be set up for this sensor to work. The device supports 400kHz
operation, so you may specify up to `frequency: 400kHz` in your `i2c` configuration.

{{< img src="mmc5983.jpg" alt="Image" caption="MMC5983 Magnetometer." width="30.0%" class="center" >}}
