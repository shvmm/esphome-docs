...
with ESPHome. This component is a global hub that establishes the connection to the RDM6300 via [UART](#uart) and
...
{{< img src="rdm6300-full.jpg" alt="Image" width="60.0%" class="center" >}}
...
to have an [UART bus](#uart) in your configuration with the `rx_pin` connected to the data pin of the RDM6300 and
...
{{< img src="rdm6300-ui.png" alt="Image" width="80.0%" class="center" >}}
