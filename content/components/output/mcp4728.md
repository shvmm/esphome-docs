...
in order to have analog outputs on any board by using [I²C](#i2c). Devices default address is `0x60`.
...
- **mcp4728_id** (*Optional*, [ID](#config-id)): Manually specify the ID of the
