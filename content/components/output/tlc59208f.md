...
uses [I²C Bus](#i2c) for communication.
...
{{< img src="tlc59208f-full.jpg" alt="Image" caption="Sample application of a TLC59208F 8-Channel PWM Driver." width="75.0%" class="center" >}}
...
- **tlc59208f_id** (*Optional*, [ID](#config-id)): Manually specify the ID of the
