...
-  **data_pin** (**Required**, [Pin Schema](#config-pin_schema)): The pin which DI is connected
   to.
-  **clock_pin** (**Required**, [Pin Schema](#config-pin_schema)): The pin which DCKI is
   connected to.
...
- **my9231_id** (*Optional*, [ID](#config-id)): Manually specify the ID of the
