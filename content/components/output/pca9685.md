...
{{< img src="pca9685-full.jpg" alt="Image" caption="PCA9685 16-Channel PWM Driver." width="75.0%" class="center" >}}
...
- **pca9685_id** (*Optional*, [ID](#config-id)): Manually specify the ID of the
