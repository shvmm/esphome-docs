...
([datasheet](https://www.ti.com/lit/ds/symlink/tca9555.pdf)) in ESPHome. It uses [I²C Bus](#i2c) for communication.
...
- **id** (**Required**, [ID](#config-id)): The id to use for this TCA9555 component.
- **address** (*Optional*, int): The I²C address of the driver.
  Defaults to `0x21`.

## Pin configuration variables:

- **TCA9555** (**Required**, [ID](#config-id)): The id of the TCA9555 component of the pin.
