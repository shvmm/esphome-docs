...
{{< /note >}}
{{< img src="am43.jpg" alt="Image" class="right" >}}
...
See [Setting up devices](#esp32_ble_tracker-setting_up_devices) for
...
- **ble_client_id** (**Required**, [ID](#config-id)): The id of the `ble_client` entry associated with the device.
