...
The [I²C bus](#i2c) is required in your configuration as this is used to communicate with the ES8156.
...
- **i2c_id** (*Optional*): The ID of the [I²C bus](#i2c) the ES8156 is connected to.
