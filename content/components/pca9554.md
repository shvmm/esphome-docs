...
{{< img src="pca9554a.jpg" alt="Image" caption="PCA9554A I/O Expander chip" class="center" >}}
...
- **id** (**Required**, [ID](#config-id)): The id to use for this `pca9554` component.
...
- **pca9554** (**Required**, [ID](#config-id)): The id of the `pca9554` component of the pin.
