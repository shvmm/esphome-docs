...
{{< anchor "pn7150-component" >}}

## Component/Hub

The `pn7150` component allows you to use PN7150 NFC controllers with ESPHome. This component is a global hub that
establishes a connection to the PN7150 via [I²C](#i2c).

{{< img src="pn7150-full.jpg" alt="Image" width="70.0%" class="center" >}}

An [I²C](#i2c) bus must be defined within your device's ESPHome configuration to use the PN7150.
...
- **dwl_req_pin** (*Optional*, [Pin Schema](#config-pin_schema)): The pin connected to the PN7150's
  `DWL_REQ` line. Used to invoke the PN7150's firmware update mode; may be used in a future release.
- **irq_pin** (**Required**, [Pin Schema](#config-pin_schema)): The pin connected to the PN7150's `IRQ` line.
- **ven_pin** (**Required**, [Pin Schema](#config-pin_schema)): The pin connected to the PN7150's `VEN` line.
- **wkup_req_pin** (*Optional*, [Pin Schema](#config-pin_schema)): The pin connected to the PN7150's
...
{{< anchor "pn7150-actions" >}}

## Actions

{{< anchor "pn7150-set_clean_mode" >}}
...
```
{{< anchor "pn7150-set_write_message" >}}
...
```
{{< anchor "pn7150-set_emulation_message" >}}
...
```
{{< anchor "pn7150-on_emulated_tag_scan" >}}
