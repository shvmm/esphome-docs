...
{{< img src="sx1509-full.jpg" alt="Image" caption="SX1509 16 channel I/O Expander." width="80.0%" class="center" >}}
...
{{< img src="sx1509-keypad.jpg" alt="Image" caption="SX1509 pins for keypad setup (image from the datasheet)." width="80.0%" class="center" >}}
