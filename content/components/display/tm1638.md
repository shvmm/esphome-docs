...
{{< img src="tm1638-full.jpg" alt="Image" caption="TM1638 8-Segment Display Keypad & LED Module." width="75.0%" class="center" >}}
...
- **stb_pin** (**Required**, [Pin Schema](#config-pin_schema)): The pin you have the STB line hooked up to.
...
- **lambda** (*Optional*, [lambda](#config-lambda)): The lambda to use for rendering the content on the TM1638.
...
The TM1638 has a similar API to the fully fledged [Display Rendering Engine](#display-engine), but it's only a subset as the TM1638
