...
{{< img src="st7735.jpg" alt="Image" caption="ST7735 Display" width="75.0%" class="center" >}}
...
- **update_interval** (*Optional*, [Time](#config-time)): Time between display updates. Default is 1s.
