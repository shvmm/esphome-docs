...
component is for displays that are connected via the 4-Wire [SPI bus](#spi).

{{< img src="ssd1325-full.jpg" alt="Image" caption="SSD1325 OLED Display" width="75.0%" class="center" >}}
...
- **cs_pin** (*Optional*, [Pin Schema](#config-pin_schema)): The pin on the ESP that that the CS line is connected to.
