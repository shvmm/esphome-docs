...
{{< img src="ssd1351-full.jpg" alt="Image" caption="SSD1351 OLED Display" width="75.0%" class="center" >}}
...
- **cs_pin** (**Required**, [Pin Schema](#config-pin_schema)): The pin on the ESP that that the CS line is connected to.
...
Add a `color:` section to your YAML configuration; please see [color](#config-color) for more detail on this configuration section.
