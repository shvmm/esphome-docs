...
displays with ESPHome. Note that this component is for displays that are connected via the [I²C Bus](#i2c).
If your SSD1306/SSD1305 or SH1106 is connected via the 4-Wire [SPI bus](#spi), see [Over SPI](#ssd1306-spi).

{{< img src="ssd1306-full.jpg" alt="Image" caption="SSD1306 OLED Display" width="75.0%" class="center" >}}

Connect D2 to the SCL pin you chose for the [I²C Bus](#i2c), and connect D1 to the SDA pin. For power, connect
...
- **address** (*Optional*, int): Manually specify the [I²C](#i2c) address of the display. Defaults to 0x3C.
...
If your SSD1306 or SH1106 is connected via the [I²C Bus](#i2c), see [Over I²C](#ssd1306-i2c).
