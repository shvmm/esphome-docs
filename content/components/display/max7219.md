...
{{< img src="max7219-full.jpg" alt="Image" caption="MAX7219 7-Segment Display." width="75.0%" class="center" >}}
...
- **lambda** (*Optional*, [lambda](#config-lambda)): The lambda to use for rendering the content on the MAX7219.
...
The MAX7219 has a similar API to the fully fledged [Display Rendering Engine](#display-engine), but it's only a subset as the MAX7219
