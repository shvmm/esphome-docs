...
| --- | --- | --- |
|  `GPIO0`  If |  HIGH on boot                We |  ak Pull Up |
|  `GPIO2`  If |  HIGH on boot                We |  ak Pull Up |
|  `GPIO4` |  Hi |  gh Impedance |
|  `GPIO5` |  Hi |  gh Impedance |
|  `GPIO6` |  We |  ak Pull Up |
|  `GPIO12` |  We |  ak Pull Up |
|  `GPIO13` |  We |  ak Pull Up |
|  `GPIO14` |  We |  ak Pull Up |
|  `GPIO15` If |  LOW on boot                 We |  ak Pull Up |
|  `GPIO16` Ha |  s pull-down (but no pull-up) We |  ak Pull Down |
|   |  resistor |
