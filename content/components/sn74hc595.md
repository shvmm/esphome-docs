...
{{< img src="sn74hc595-full.jpg" alt="Image" caption="SN74HC595 I/O Expander (shift register)." width="80.0%" class="center" >}}

The component can be configured using [GPIO pins](#config-pin_schema) or the [SPI Bus](#spi).
...
- **id** (**Required**, [ID](#config-id)): The id to use for this SN74HC595 component.
- **data_pin** (**Required**, [Pin Schema](#config-pin_schema)): Pin connected to SN74HC595 SER (SD) input.
- **clock_pin** (**Required**, [Pin Schema](#config-pin_schema)): Pin connected to SN74HC595 SRCLK (SH_CP) pin
- **latch_pin** (**Required**, [Pin Schema](#config-pin_schema)): Pin connected to SN74HC595 RCLK (ST_CP) pin
- **oe_pin** (*Optional*, [Pin Schema](#config-pin_schema)): Pin connected to SN74HC595 OE pin
...
- **id** (**Required**, [ID](#config-id)): The id to use for this SN74HC595 component.
- **spi_id** (**Required**, [SPI Bus Schema](#spi)): The SPI bus to use. This will automatically be set to the ID of the SPI bus if there is only one.
...
```
- **sn74hc595** (**Required**, [ID](#config-id)): The id of the SN74HC595 component of the pin.
