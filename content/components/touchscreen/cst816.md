...
{{< img src="cst816.jpg" alt="Image" caption="cst816t touchscreen on T-Display S3 AMOLED" width="50.0%" class="center" >}}
...
the cst816 can report touches on a dedicated button outside the display area. This can be utilised by configuring a [touchscreen binary sensor](#touchscreen_binary_sensor)
