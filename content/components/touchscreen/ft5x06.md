...
{{< img src="indicator.jpg" alt="Image" caption="ft5x06 touchscreen in Seeed Studio Sensecap Indicator." width="50.0%" class="center" >}}
...
- **interrupt_pin** (*Optional*, [Pin Schema](#config-pin_schema)): The GPIO pin to use as the interrupt pin.
