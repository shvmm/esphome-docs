...
{{< img src="esp32-s3-box.png" alt="Image" caption="TT21100 touchscreen on ESP32-S3-BOX" width="50.0%" class="center" >}}

{{< img src="esp32-s3-korvo-2.png" alt="Image" caption="TT21100 touchscreen on ESP32-S3-Korvo-2" width="50.0%" class="center" >}}
...
- **interrupt_pin** (**Required**, [Pin Schema](#config-pin_schema)): The touch detection pin.
...
- **tt21100_id** (*Optional*, [ID](#config-id)): Manually specify the ID of the touchscreen.
