...
{{< img src="t4-s3.jpg" alt="Image" caption="cst226 touchscreen on Lilygo T4-S3 AMOLED Display" width="50.0%" class="center" >}}
...
- **cst226_id** (*Optional*, [ID](#config-id)): Manually specify the ID of the touchscreen.
