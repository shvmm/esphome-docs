...
and is now using a community fork [pioarduino/platform-espressif32](https://github.com/pioarduino/platform-espressif32) as platformio
...
the [ESPHome issue tracker](https://github.com/esphome/esphome/issues) on GitHub.
