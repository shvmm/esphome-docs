...
{{< img src="live-validation.png" alt="Image" width="70.0%" class="center" >}}
...
- Added [globals.set](#globals-set_action) action,
  [script.is_running](#script-is_running_condition) condition,
  [for](#for_condition) condition.
- Custom components can now access ESPHome's global variables.
- Added `restore_mode` for lights and [light.is_on/off](#light-is_on_condition).
