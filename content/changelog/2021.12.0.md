...
Today is the [State of the Open Smart Home](https://www.home-assistant.io/state-of-the-open-home/) hosted by Nabu Casa, Home Assistant & ESPHome
...
This release brings {{< docref "/components/button/index" "buttons" >}} from Home Assistant. Many times there have been questions on how to simply trigger automations
...
{{< pr number="2637" repo="esphome" >}} adds new functionality to the Tuya cover component, but at the same time removes the "soft"
inversion of the direction. Instead, it seems that most if not all tuya covers have a "hidden" datapoint that
sets the direction on the secondary MCU. See the {{< docref "/components/cover/tuya" "documentation" >}} for the new
