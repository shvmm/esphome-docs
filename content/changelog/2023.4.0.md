...
We've added a new {{< docref "/components/voice_assistant" >}} component that allows you to use ESPHome devices as an input
for [assist](https://www.home-assistant.io/voice_control/) in Home Assistant **2023.5 or later**.

With this also comes preliminary {{< docref "/components/microphone/index" "microphone" >}} support, which has been built in a way that multiple
