...
If you already have a stack trace but need to decode it, you can use the [ESP Stack Trace Decoder](https://esphome.github.io/esp-stacktrace-decoder/) web tool:
